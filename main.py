...
icon = pygame.image.load("image/robot.png")
pygame.display.set_icon(icon)
clock = pygame.time.Clock()

background = pygame.image.load("image/back1.png")
...
uno = pygame.image.load("image/uno.png")
uno = pygame.transform.scale(uno, (80, 80))
dos = pygame.image.load("image/dos.png")
dos = pygame.transform.scale(dos, (80, 80))
singko = pygame.image.load("image/singko.png")
